...
public class ImageServiceImpl implements ImageService {
	 ...
	 BiscuitRepository biscuitRepository;
		...
		@Override
		public Image uplaodImageBisc(MultipartFile file,Long idBisc) 
		throws IOException {
				Biscuit b = new Biscuit();
				b.setIdBiscuit(idBisc);
		...
		@Override
		public List<Image> getImagesParBisc(Long biscId) {
			Biscuit b = biscuitRepository.findById(biscId).get();
				return b.getImages();
		}
